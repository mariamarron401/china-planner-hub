...
export const DAY_TIMELINE: Record<string, TimelineEntry[]> = {
  ...
  '2026-10-24': [
    ...
    { time: '11:00', what: '🌉 GRAN CAÑÓN + PUENTE DE CRISTAL. Franja horaria reservada y entrada aparte de la del parque Avatar.', kind: 'clave' },
    { time: '', what: 'La ruta son 2-4 h: puente de cristal (430 m de largo, 300 m de alto), bajada al fondo por escaleras y pasarelas, paseo junto al agua y barca por el lago hasta la salida.' },
    { time: '', what: '⚠️ El puente cierra sobre las 15:30 y varía con la temporada. Reconfirmad la hora de última entrada al reservar.', kind: 'clave' },
    { time: '', what: '🥾 Calzado con suela que agarre: si ha llovido, la bajada resbala. Al puente se entra con fundas en los zapatos, que se cogen allí.' },
    { time: '', what: '⚠️ Reservad ya la franja horaria de MAÑANA para el parque Avatar: es otra entrada y necesita su propia franja.', kind: 'clave' },
  ],
  '2026-10-25': [
