...
export function answerQuestion(rawQuestion: string, data: TripData): string {
  ...
  if (has(q, ['maleta', 'equipaje', 'baggage', 'facturar', 'facturad'])) {
    return `🧳 **Equipaje: 8 bultos en total** — 2 maletas facturadas + 2 de cabina cada uno. El seguro cubre robo/daños hasta 1.500 € y demora hasta 150 €.\n\n🚗 **En Didi pedid siempre coche de 6 plazas (六座).** Un Didi normal (快车) es un turismo y con 4 maletas grandes NO cabéis. Para los traslados críticos, dejadlo **programado con antelación** (Didi admite reservas hasta 7 días antes y deja el precio cerrado): sobre todo el del **21/10 a Chongqing East**, que son 21 km a las 07:15.\n\n🚄 **En el tren**, las maletas grandes van en los **estantes de los extremos del vagón**, no en el portaequipajes de encima del asiento. Truco: al elegir asiento, coger **la fila 1 o la última del vagón**, que es donde están esos estantes — así no arrastráis las maletas por el pasillo ni las perdéis de vista.\n\n📏 Regla oficial en trenes G: cada bulto, sumando largo + ancho + alto, no debería pasar de **130 cm** (una maleta de 28" ronda los 158 cm). En la práctica no miden salvo que sea algo escandaloso, pero conviene saberlo.\n\n👉 Además, cada tren está cuadrado con el check-out del hotel de origen y el check-in del destino para no quedaros tirados con el equipaje. Pregúntame por un tramo concreto.`;
  }
