...
export const initialTripData: TripData = {
  ...
  hotels: [
    { id: 'h-bj-1', cityId: 'beijing', provider: 'Trip.com', totalPrice: 238.86, currency: 'EUR', link: 'https://es.trip.com/hotels/Pek%C3%ADn-hotel-detail-821303/Livefortuna-Hotel/', breakfastIncluded: true, priceStatus: 'known', name: 'Liveforturna Hotel (北京福庭酒店)', checkInText: '10 oct', checkOutText: '13 oct', paymentNote: 'Pago más tarde, se cobra el 8/10', booked: true },
    ...
    { id: 'h-xa-confirmed', cityId: 'xian', provider: 'Trip.com', totalPrice: 109.80, currency: 'EUR', link: 'https://www.trip.com/w/ewFa9IEOYT2', breakfastIncluded: true, priceStatus: 'known', name: "Center Hotel (Xi'an Bell Tower)", checkInText: '13 oct', checkOutText: '16 oct', paymentNote: 'Pago más tarde, se cobra el 11/10', booked: true },
    ...
    { id: 'h-cd-confirmed', cityId: 'chengdu', provider: 'Trip.com', totalPrice: 96.14, currency: 'EUR', link: 'https://www.trip.com/w/TQzllDaOYT2', breakfastIncluded: true, priceStatus: 'known', name: 'Guilaiqi Boutique Hotel (Chunxi Road Xinnanmen Subway)', checkInText: '16 oct', checkOutText: '19 oct', paymentNote: 'Pago más tarde, se cobra el 13/10', booked: true },
    ...
    { id: 'h-cq-confirmed', cityId: 'chongqing', provider: 'Trip.com', totalPrice: 84.84, currency: 'EUR', link: 'https://www.trip.com/w/m7bYP9rOYT2', breakfastIncluded: true, priceStatus: 'known', name: 'Hongyadong Holiday Riverside Hotel (Jiefangbei)', checkInText: '19 oct', checkOutText: '21 oct', paymentNote: 'Pago más tarde, se cobra el 17/10', booked: true },
    ...
    { id: 'h-fh-confirmed', cityId: 'fenghuang', provider: 'Trip.com', totalPrice: 76.24, currency: 'EUR', link: 'https://www.trip.com/w/08v358BPYT2', breakfastIncluded: true, priceStatus: 'known', name: 'Secluded Qian Mansion (Phoenix Ancient Town)', checkInText: '21 oct', checkOutText: '22 oct', paymentNote: 'Pago completado, no reembolsable', booked: true },
    ...
    { id: 'h-fr-confirmed', cityId: 'furong', provider: 'Trip.com', totalPrice: 108.82, currency: 'EUR', link: 'https://www.trip.com/w/lqqRdDPPYT2', breakfastIncluded: true, priceStatus: 'known', name: 'Wangcun Caotang Inn (Furong Town Waterfall)', checkInText: '22 oct', checkOutText: '23 oct', paymentNote: 'Pago más tarde, se cobra el 20/10', booked: true },
    ...
    { id: 'h-zj-confirmed', cityId: 'zhangjiajie', provider: 'Trip.com', totalPrice: 35.71, currency: 'EUR', link: 'https://www.trip.com/w/yBJsyOkPYT2', breakfastIncluded: true, priceStatus: 'known', name: 'Thousand Hotel (天门山仟酒店)', checkInText: '23 oct', checkOutText: '24 oct', paymentNote: 'Pago más tarde, se cobra el 21/10', booked: true },
    ...
    { id: 'h-wl-confirmed', cityId: 'wulingyuan', provider: 'Trip.com', totalPrice: 59.98, currency: 'EUR', link: 'https://www.trip.com/w/AgqY9N8BeT2', breakfastIncluded: true, priceStatus: 'known', name: 'Tianchong Yunhai Resort Hotel (Wulingyuan Natl Forest Park)', checkInText: '24 oct', checkOutText: '26 oct', paymentNote: 'Pago más tarde, se cobra el 22/10', booked: true },
    { id: 'h-sr-1', cityId: 'shangrao', provider: 'Trip.com', totalPrice: 149.81, currency: 'EUR', link: 'https://www.trip.com/w/FQ9hm1kAeT2', breakfastIncluded: true, priceStatus: 'known', name: 'Yangxian Village, Wangxian Valley (望仙谷仰仙村)', checkInText: '26 oct', checkOutText: '27 oct', paymentNote: 'Pago completado, no reembolsable. Incluye 1 entrada al área escénica', booked: true },
    ...
    { id: 'h-sh-confirmed', cityId: 'shanghai', provider: 'Trip.com', totalPrice: 381.63, currency: 'EUR', link: 'https://www.trip.com/w/PdYbda5QYT2', breakfastIncluded: true, priceStatus: 'known', name: "Meta Tree Hotel, People's Square, City Center", checkInText: '27 oct', checkOutText: '1 nov', paymentNote: 'Pago más tarde, se cobra el 25/10', booked: true },
  ],
  selectedHotels: {
    beijing: 'h-bj-1',
    xian: 'h-xa-confirmed',
